...
foreach(
  ['simple_carping_pipeline1.vtf', 255, 'Node d has poorly described port __IN1__'],
  ['simple_failing_io_pipeline1.vtf', 255, 'Node d has no port __IN_N2__'],
  ['simple_failing_io_pipeline2.vtf', 255, 'Node d port __OUT_2__ connected as "to"'],
  ['simple_failing_pipeline.vtf', 10, 'Exiting due to abnormal return from child n2'],
  ['simple_pipeline.vtf', 0, '(viv) - Done']
){
