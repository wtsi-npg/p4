...
foreach(
  ['50-viv_failing_io_pipeline0.vtf', 255, 'ERROR: to port d:__IN1__ referenced in edge, but no corresponding port found in nodes'],
  ['50-viv_failing_io_pipeline1.vtf', 255, 'ERROR: to port d:__IN_N2__ referenced in edge, but no corresponding port found in nodes'],
  ...
  ['50-viv_failing_io_pipeline1.v2.vtf', 255, 'ERROR: to port d:__IN_N2__ referenced in edge, but no corresponding port found in nodes'],
